<?php
    ...
    $result = $db->getResultSet('patient_mstr', ['patient_code','patient_name','patient_kk','patient_dose', 'patient_volume'],
        ["patient_code = '$code'", 'patient_m1mout = "Y"', 'patient_active = "Y"']);
